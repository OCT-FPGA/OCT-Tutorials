...
You will have two keys; a public key and a private key. The public key ends with the extension .pub. If you want to access a CloudLab node, [this key needs to be copied when you set up your CloudLab experiment](https://github.com/OCT-FPGA/oct-tutorials/tree/master/cloudlab-setup#12-existing-users).  
